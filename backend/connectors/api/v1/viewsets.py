...
class Testconnectors137631ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS137631_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS137631_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS137631"
